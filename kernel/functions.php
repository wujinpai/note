...
$filePath = [
    "{$dir}css/main.css", "{$dir}css/settings.css", "{$dir}css/icon-main.css", "{$dir}css/icon-icomoon.css", "{$dir}css/markdown.css",
    "{$dir}js/main.js", "{$dir}js/module.js", "{$dir}js/settings.js", "{$dir}js/markdown.js"
];
