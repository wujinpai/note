...
<head>
    ...
    <link rel="stylesheet" href="<?php echo cachev("kernel/asset/css/markdown.css") ?>">
    <!-- KaTeX 数学公式支持 -->
...
' : ''; ?>
    ...
    <script src="<?php echo cachev("kernel/asset/js/markdown.js") ?>" defer></script>
    <script src="<?php echo cachev("kernel/asset/js/markdown-editor.js") ?>" defer></script>
